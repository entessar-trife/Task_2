export const FeaturesCardData = [
  {
    imgSrc: "/Task_2/images/Features/Icon(1).png",
  ...
  {
    imgSrc: "/Task_2/images/Features/Icon(2).png",
  ...
  {
    imgSrc: "/Task_2/images/Features/Icon(3).png",
  ...
  {
    imgSrc: "/Task_2/images/Features/Icon(4).png",
  ...
  {
    imgSrc: "/Task_2/images/Features/Icon(5).png",
  ...
  {
    imgSrc: "/Task_2/images/Features/Icon(6).png",
